PROMPT_TEMPLATES = {
    "no_style": {
        ...
        "end_of_seq": "",
        "note": "Used for falcon.",
    },
    "llama2": {
        "format": "<s>[INST] {} [/INST]",
        "format_system": "<s>[INST] <<SYS>>\n{system_prompt}\n<</SYS>>\n\n{prompt} [/INST]",  # noqa: E501
        "end_of_seq": "</s>",
        "note": "Few shot example answers should be ended with </s>.",
    },
    "zephyr": {
        "format": "<|user|>\n{}</s>\n<|assistant|>\n",
    ...
    "alpaca": {
        ...
        "end_of_seq": "",
        "note": "No real system prompt format. New line is used as EOS token.",
    },
    "alpaca_human": {
        "format": "### HUMAN:\n{}\n\n### RESPONSE:\n",
        "format_system": "### HUMAN:\n{system_prompt}\n\n### INPUT:\n{prompt}\n\n### RESPONSE:\n{prompt}",  # noqa: E501
    ...
    "vicuna": {
        ...
        "end_of_seq": "",
        "note": "No real system prompt format.",
    },
}
